...
args = sys.argv
run_id = "b0da55ae-f9d7-497a-821d-30e05b16c361"
aml_token = None
script_directory = None
print("Starting the Model explain run....")

preprocess = "False"  # PLACEHOLDER
run_id = "b0da55ae-f9d7-497a-821d-30e05b16c361"  # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'save_mlflow':True,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'whitelist_models':None,'compute_target':'affan-compute-cluster01','enable_dnn':False,'enable_code_generation':True,'experiment_exit_score':None,'experiment_timeout_minutes':180,'featurization':{'_blocked_transformers':[],'_column_purposes':{'AGE':'Text','Phone':'Text','YearOfBirth_of_Customer':'Text','Billing_Zip':'Text'},'_transformer_params':{'Imputer':[]},'_drop_columns':['CustomerID','Customer_Name']},'hyperdrive_config':None,'grain_column_names':None,'is_timeseries':False,'iteration_timeout_minutes':180,'max_concurrent_iterations':2,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'exp-day2-no2','path':'./sample_projects/exp-day2-no2','primary_metric':'r2_score','region':'centralindia','resource_group':'rg-sbihackathon','subscription_id':'0f644ff4-434a-4446-a414-16ddb2b713ee','task_type':'regression','validation_size':None,'test_size':0.15,'vm_type':'STANDARD_DS3_V2','workspace_name':'ml-demo-explore','label_column_name':'CustomerScore','enable_batch_run':True,'dataset_id':'117aaefb-cf85-436d-a66f-9ba14ce81af0'} # PLACEHOLDER for AutoMLSettings
model_explain_run_type = "on_demand" # PLACEHOLDER for ModelExplainRunType
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"117aaefb-cf85-436d-a66f-9ba14ce81af0\"}}" # PLACEHOLDER
mltable_data_json = None # PLACEHOLDER
on_demand_run_id = "AutoML_8ccb5eb3-3685-4f90-a296-42445ae933f2_15"  # PLACEHOLDER
